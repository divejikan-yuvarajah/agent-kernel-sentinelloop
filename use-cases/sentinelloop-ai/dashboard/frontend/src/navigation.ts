export const NAV_GROUPS = [
  {
    ...
    links: [
      ...
      { to: "/report", label: "Log a hazard", icon: "incidents" as const },
      { to: "/sandbox", label: "Try It Live", icon: "alerts" as const },
...
export const ROUTE_CRUMBS: { prefix: string; label: string; to?: string }[] = [
  ...
  { prefix: "/report", label: "Log a hazard", to: "/report" },
  { prefix: "/sandbox", label: "Try It Live", to: "/sandbox" },
